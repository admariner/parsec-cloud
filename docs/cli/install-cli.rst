...
.. |parsec-version| replace:: ``parsec-cli 3.9.4-a.0.dev.20711+b35e082``
...
.. _Parsec CLI: https://github.com/Scille/parsec-cloud/releases/download/v3.9.4-a.0.dev.20711+b35e082/parsec-cli_3.9.4-a.0.dev.20711+b35e082_linux-x86_64-musl
...
2. Make the file executable
   ...
   - Or use the :command:`chmod` command:
     ...
     .. code-block:: shell
        ...
        chmod +x parsec-cli_3.9.4-a.0.dev.20711+b35e082_linux-x86_64-musl

3. Verify the installation by running the following command:

   .. code-block:: shell

      ./parsec-cli_3.9.4-a.0.dev.20711+b35e082_linux-x86_64-musl --version
...
4. For convenience, put the executable in ``~/.local/bin``
   ...
   .. code-block:: shell
      ...
      cp parsec-cli_3.9.4-a.0.dev.20711+b35e082_linux-x86_64-musl ~/.local/bin
   ...
   .. code-block:: shell
      ...
      cd  ~/.local/bin
      ln -s parsec-cli_3.9.4-a.0.dev.20711+b35e082_linux-x86_64-musl parsec-cli
