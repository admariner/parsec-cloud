...
.. _webapp: https://github.com/Scille/parsec-cloud/releases/download/v3.9.1-a.0.dev.20634+1a4f1bf/parsec-web-3.9.1-a.0.dev.20634+1a4f1bf.zip
...
#. For the current release, you can download the webapp by using this link: `webapp`_:
   ...
   .. code-block:: shell
      ...
      curl --fail -L -o parsec-web.zip \
        https://github.com/Scille/parsec-cloud/releases/download/v3.9.1-a.0.dev.20634+1a4f1bf/parsec-web-3.9.1-a.0.dev.20634+1a4f1bf.zip
