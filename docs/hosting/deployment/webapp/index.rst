...
.. _webapp: https://github.com/Scille/parsec-cloud/releases/download/v3.9.4-a.0.dev.20719+5cc5421/parsec-web-3.9.4-a.0.dev.20719+5cc5421.zip
...
#. For the current release, you can download the webapp by using this link: `webapp`_:
   ...
   .. code-block:: shell
      ...
      curl --fail -L -o parsec-web.zip \
        https://github.com/Scille/parsec-cloud/releases/download/v3.9.4-a.0.dev.20719+5cc5421/parsec-web-3.9.4-a.0.dev.20719+5cc5421.zip
