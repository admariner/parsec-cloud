...
.. _Parsec CLI v3.4.1-a.0.dev.20295+3a03d3b: https://github.com/Scille/parsec-cloud/releases/download/v3.4.1-a.0.dev.20295+3a03d3b/parsec-cli_3.4.1-a.0.dev.20295+3a03d3b_linux-x86_64-musl

1. Download the CLI by following this link:

   `Parsec CLI v3.4.1-a.0.dev.20295+3a03d3b`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.4.1-a.0.dev.20295+3a03d3b_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.4.1-a.0.dev.20295+3a03d3b_linux-x86_64-musl --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.4.1-a.0.dev.20295+3a03d3b
