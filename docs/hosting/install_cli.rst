...
.. _Parsec CLI v3.5.0-a.6.dev.20343+848983c: https://github.com/Scille/parsec-cloud/releases/download/v3.5.0-a.6.dev.20343+848983c/parsec-cli_3.5.0-a.6.dev.20343+848983c_linux-x86_64-musl

1. Download the CLI by following this link:

   `Parsec CLI v3.5.0-a.6.dev.20343+848983c`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.5.0-a.6.dev.20343+848983c_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.5.0-a.6.dev.20343+848983c_linux-x86_64-musl --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.5.0-a.6.dev.20343+848983c
