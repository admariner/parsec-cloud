...
.. _Parsec CLI v3.5.3-a.0.dev.20386+276350f: https://github.com/Scille/parsec-cloud/releases/download/v3.5.3-a.0.dev.20386+276350f/parsec-cli_3.5.3-a.0.dev.20386+276350f_linux-x86_64-musl

1. Download the CLI by following this link:

   `Parsec CLI v3.5.3-a.0.dev.20386+276350f`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.5.3-a.0.dev.20386+276350f_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.5.3-a.0.dev.20386+276350f_linux-x86_64-musl --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.5.3-a.0.dev.20386+276350f
