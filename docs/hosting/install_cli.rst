...
.. _Parsec CLI v3.7.2-a.0.dev.20471+8c87f1d: https://github.com/Scille/parsec-cloud/releases/download/v3.7.2-a.0.dev.20471+8c87f1d/parsec-cli_3.7.2-a.0.dev.20471+8c87f1d_linux-x86_64-musl

1. Download the CLI by following this link:

   `Parsec CLI v3.7.2-a.0.dev.20471+8c87f1d`_.
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.7.2-a.0.dev.20471+8c87f1d_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.7.2-a.0.dev.20471+8c87f1d_linux-x86_64-musl --version

  The CLI should output its version:

  .. code-block::

      parsec-cli 3.7.2-a.0.dev.20471+8c87f1d
